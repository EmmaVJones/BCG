...
att <- read.csv('C:/HardDriveBackup/R/BCG/FinalTaxaLists/FinalTaxaAttributes.csv')
...
SubBresults_lou <- SubbasinConnection(hw1)
BCG_GIS <- rbind(BCG_GIS,BCG_Model_GIS(SubBresults_lou))

write.csv(BCG_GIS,'EmmaBCGmodelresults.csv',row.names=F)
